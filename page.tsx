...
export default function Page() {
  ...
  const artworks = [
    ...
    },
    {
      ...
      medium: "Ink on paper",
      dimensions: "32 x 24 cm.",
      alt: "Illustration of abstact lines",
    },
    {
      id: 18,
      src: "/Acantilados.jpg",
      title: "Acantilados (series)",
      medium: "Ink on paper",
      dimensions: "18 x 18 cm.",
      alt: "Illustration of cliffs",
    },
    {
      id: 19,
      src: "/Tejido.jpg",
    ...
    },
    {
      id: 20,
      src: "/Eclosion.jpg",
      title: "Eclosion (series)",
      medium: "Inks and watercolours on paper",
      dimensions: "42 x 30 cm.",
      alt: "Abstract action painting",
    },
    {
      id: 21,
      src: "/Self portrait in London.jpg",
      title: "Self portrait in London",
      medium: "Collage",
      dimensions: "79.4 x 52.7 cm.",
      alt: "Self portrait made with pieces of paper",
    },
    {
      id: 22,
      src: "/Untitled-5.jpg",
      ...
      alt: "Drawing of a lady",
    },
    {
      id: 23,
      src: "/Autorretrato en Madrid.jpg",
      title: "Autorretrato en Madrid",
      medium: "Mixed media",
      dimensions: "61 x 87 cm.",
      alt: "Self portrait made with pieces of paper and ink",
    },
    {
      id: 24,
      src: "/autorretrato en magenta.jpg",
      title: "Autorretrato en magenta",
      medium: "Oil painting and acrylic on canvas",
      dimensions: "100 x 100 cm.",
      alt: "High constrast self portrait in magenta",
    },
    {
      id: 25,
      ...
      alt: "Self portrait made with pieces of paper and trash",
    },
    {
      id: 26,
      src: "/sin titulo.jpg",
      title: "Sin titulo",
      medium: "Oil painting and acrylic on MDF",
      dimensions: "30 x 80 cm.",
      alt: "Self portrait over a dard background",
    },
    {
      id: 27,
      src: "/Autorretrato en Salamanca.jpg",
      title: "Autorretrato en Salamanca",
      medium: "Mixed media",
    ...
    },
    {
      ...
      alt: "Painting of a woman laying down with a dog in her hands",
    },
    {
      id: 29,
      src: "/Untitled-4.jpg",
    ...
    {
      id: 30,
      src: "/Votre femme belge a la carte.jpg",
      title: "Votre femme belge a la carte",
      medium: "Intervened butcher shop's poster",
      dimensions: "55 x 80 cm.",
      alt: "Intervened butcher shop's poster",
    },
    {
      id: 31,
      src: "/Vanidad.jpg",
      title: "Vanidad",
      medium: "Encaustic, oil painting and paper on canvas",
      dimensions: "100 x 100 cm.",
      alt: "Painting of a skull",
    },
    {
      id: 32,
      src: "/bailare.jpg",
      title: "Bailaré sobre tu tumba (series)",
      medium: "Graphite on paper",
      dimensions: "25 x 30 cm.",
      alt: "Drawing of a heeled shoe",
    },
    {
      id: 33,
      src: "/presente.jpg",
      ...
      alt: "Illustration of a skull",
    },
    {
      id: 34,
      src: "/Percepciones 4.jpg",
      title: "Percepciones (series)",
      medium: "Graphite and casein on MDF",
      dimensions: "15 x 15 cm.",
      alt: "Small drawing of a woman's face",
    },
    {
      id: 35,
      src: "/ejercicio botanico.jpg",
      title: "Ejercicio botánico",
      medium: "Ink on paper",
